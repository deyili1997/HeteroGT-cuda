...
class HeteroGT(nn.Module):
    ...
    def build_patient_graph(self, seq_embed_p, token_types_p, visit_embed_p, adm_index_p, graph_node_type_ids):
        ...
        seq_embed_p = seq_embed_p[token_types_p != self.group_type_id]
        token_types_p = token_types_p[token_types_p != self.group_type_id]
        adm_index_p = adm_index_p[token_types_p != self.group_type_id]

...
class SetGNN(nn.Module):
    ...
    def forward(self, data, global_node_ids, last_visit_indices, edge_weight=None):
        """
        ...
        # print("x.shape after select last visits", last_visit_embeds.shape)

        prediction = self.downstream_cls(last_visit_embeds)
        return prediction